...
class PopUp extends ObjectModel
{
    ...
    public static $definition = [
        ...
        'fields' => [
            ...
            'active' => ['type' => self::TYPE_BOOL, 'validate' => 'osBool', 'required' => true],
            'affiche_home' => ['type' => self::TYPE_BOOL, 'validate' => 'osBool', 'required' => true],
            'affiche_categories' => ['type' => self::TYPE_STRING]
        ]
    ];
}